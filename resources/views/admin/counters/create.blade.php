...
@section('content')
    ...
    <script>
        document.getElementById('create-counter-form').addEventListener('submit', function(event) {
            ...
            fetch("{{ route('admin.counters.store') }}", {
                method: 'POST',
                headers: {
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles mb-4 py-3">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <h3 class="me-auto my-0">Create Counter</h3>
                <div>
                        ...
                        <form id="create-counter-form">
                            ...
                            <div class="row gy-3">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input  type="number" name="value" id="value" class="form-control solid" placeholder="Value"
                                             required>
                                             <span class="error" id="value-error"></span>
                                    </div>
