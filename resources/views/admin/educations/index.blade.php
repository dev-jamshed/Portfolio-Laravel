...
@section('content')
    <h1>Educations</h1>
    <a href="{{ route('admin.educations.create') }}">Create New Education</a>
    ...
    <script>
        $(document).ready(function() {
            $('#educations-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.educations.data') }}",
                columns: [
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles mb-4 py-3">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <h3 class="me-auto my-0">Educations</h3>
                <div>
                    <a href="{{ route('admin.educations.create') }}"
                        class="btn btn-primary me-3"><i class="fas fa-plus me-2"></i>Add Education
                    </a>
                </div>
            </div>
...
<script>
    ...
    function destroy(id) {
            ...
            $.ajax({ 
                url: `{{ url('admin/educations/${id}/delete') }}`, // Your route URL
                type: "GET",
