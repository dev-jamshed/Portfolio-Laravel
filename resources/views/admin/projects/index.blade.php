        ...
        $(document).ready(function() {
            $('#projects-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'main_image', name: 'main_image', render: function(data) {
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles mb-4 py-3">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <h3 class="me-auto my-0">Projects</h3>
                <div>
                    <a href="{{ route('admin.projects.create') }}"
                        class="btn btn-primary me-3"><i class="fas fa-plus me-2"></i>Add New Project
                    </a>
                </div>
            </div>
...
@section('script')
    <script>
        ...
        function destroy(id) {
                ...
                $.ajax({ 
                    url: `{{ url('admin/projects/${id}/delete') }}`, // Your route URL
                    type: "GET",
