    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles mb-4 py-3">
            ...
            <div class="d-flex align-items-center flex-wrap">
                ...
                <div>
                    <a href="{{ route('admin.services.create') }}" class="btn btn-primary me-3">
                        <i class="fas fa-plus me-2"></i>Add New Service
                    </a>
                    <a href="{{ route('admin.services.section-image') }}" class="btn btn-secondary">
                        <i class="fas fa-image me-2"></i>Update Service Section Image
                    </a>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        table =  $('#data-table').DataTable({
            ...
            columns: [
                ...
                { data: 'show_latest_service', name: 'show_latest_service', render: function(data) {
                    return data ? 'Yes' : 'No';
                }},
                { data: 'created_at' },
                { data: 'updated_at' },
