                                ...
                                <tbody>
                                    @foreach($categories as $category)
                                        <tr>
                                            ...
                                            <td>{{ $category->name }}</td>
                                            <td>
                                                <a href="{{ route('admin.skill_categories.edit', $category->id) }}" class="btn btn-primary btn-sm">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <form action="{{ route('admin.skill_categories.destroy', $category->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
